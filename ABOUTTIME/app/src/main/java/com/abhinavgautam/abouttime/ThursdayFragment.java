...
public class ThursdayFragment extends Fragment {
    private TaskDbHelper mHelperThu;
    private ArrayAdapter mAdapter2;
    private ListView mTaskListView4;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(Build.VERSION.SDK_INT>=23)
            t.setTextColor(getResources().getColor(R.color.blue,null));
        else
            t.setTextColor(getResources().getColor(R.color.blue));
        mHelperThu = new TaskDbHelper(getActivity());
        mTaskListView4 = (ListView) rootView.findViewById(R.id.listView1);
              return rootView;
    }
    private class BackgroundTask extends AsyncTask <Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog.show();
            db= mHelperThu.getReadableDatabase();
        ...
        protected void onPostExecute(Void result) {
            if (mAdapter2 == null) {
                ...
                mTaskListView4.setAdapter(mAdapter2);
            } else {
                mAdapter2.clear();
            ...
            mTaskListView4.setEmptyView(empty);
        }
        ...
        protected Void doInBackground(Void... params) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    initime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.blue, null)), 0, initime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    endtime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.blue, null)), 0, endtime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                } else
                {
                    initime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.blue)), 0, initime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    endtime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.blue)), 0, endtime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
    ...
    private class MyAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            i1.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[4]));
            i1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SQLiteDatabase db = mHelperThu.getWritableDatabase();
            ...
            final ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(main4Activity,R.style.thursday);
            ...
            noti.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[4]));
            taski.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[4]));
            taski.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SQLiteDatabase db=mHelperThu.getReadableDatabase();
                    Cursor cursor1 = db.query(TaskContract.TaskEntry.TABLE4,
                            new String[]{TaskContract.TaskEntry._ID,TaskContract.TaskEntry.COL_NOTI, TaskContract.TaskEntry.COL_INITIME, TaskContract.TaskEntry.COL_ROUTINE},
    ...
    public void setNotification(int hour,int minute,String task,int id)
    {
        ...
        Intent myIntent1 = new Intent(getContext(), UtilityReceiverThu.class);
        ...
        db.update(TaskContract.TaskEntry.TABLE4, values, "_id="+id, null);
        db.close();
    ...
    public static class UtilityReceiverThu  extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
            ...
            Intent myIntent1 = new Intent(context, UtilityReceiverThu.class);
            myIntent1.setAction("MyBroadcast");
    ...
    public void bulkDelete()
    {
        ...
        cursor.close();
        db.delete(TaskContract.TaskEntry.TABLE4, null, null);
        db.close();
        updateUI();
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(hour2>hour1||(hour2==hour1)&&(minute2>minute1))
                        {
                            ...
                            final AlertDialog dialog4= new AlertDialog.Builder(contextThemeWrapper,R.style.f)
                                    .setTitle("Do you want to get a reminder about this task every thursday?")
                                    .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if(edit)
                                            {
                                                db.update(TaskContract.TaskEntry.TABLE4, values, "_id="+idimpo, null);
                                                db.close();
                                                deleteNotification(idimpo);
                                                setNotification(hour1,minute1,task,idimpo);
                                            }
                                            else {
                                                final int id = (int) db.insertWithOnConflict(TaskContract.TaskEntry.TABLE4,
                                                        null,
                                                        values,
