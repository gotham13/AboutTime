...
public class SaturdayFragment extends Fragment {
    private TaskDbHelper mHelperSat;
    private ArrayAdapter mAdapter2;
    private ListView mTaskListView6;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(Build.VERSION.SDK_INT>=23)
            t.setTextColor(getResources().getColor(R.color.darkorange,null));
        else
            t.setTextColor(getResources().getColor(R.color.darkorange));
        mHelperSat = new TaskDbHelper(getActivity());
        mTaskListView6 = (ListView) rootView.findViewById(R.id.listView1);
        return rootView;
    }
    private class BackgroundTask extends AsyncTask <Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog.show();
            db= mHelperSat.getReadableDatabase();
        ...
        protected void onPostExecute(Void result) {
            if (mAdapter2 == null) {
                ...
                mTaskListView6.setAdapter(mAdapter2);
            } else {
                mAdapter2.clear();
            ...
            mTaskListView6.setEmptyView(empty);
        }
        @Override
        protected Void doInBackground(Void... params) {
            Cursor cursor = db.query(TaskContract.TaskEntry.TABLE6,
            ...
            while (cursor.moveToNext()) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    initime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.darkorange, null)), 0, initime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    endtime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.darkorange, null)), 0, endtime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                } else {
                    initime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.darkorange)), 0, initime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    endtime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.darkorange)), 0, endtime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
    ...
    private class MyAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            i1.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[6]));
            i1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SQLiteDatabase db = mHelperSat.getWritableDatabase();
                    db.delete(TaskContract.TaskEntry.TABLE6,
            ...
            final ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(main4Activity,R.style.saturday);
            FloatingActionButton noti=(FloatingActionButton) view.findViewById(R.id.noti);
            noti.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[6]));
            FloatingActionButton taski=(FloatingActionButton) view.findViewById(R.id.taski);
            taski.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[6]));
            taski.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SQLiteDatabase db=mHelperSat.getReadableDatabase();
                    Cursor cursor1 = db.query(TaskContract.TaskEntry.TABLE6,
                            new String[]{TaskContract.TaskEntry._ID,TaskContract.TaskEntry.COL_NOTI, TaskContract.TaskEntry.COL_INITIME, TaskContract.TaskEntry.COL_ROUTINE},
    ...
    public void setNotification(int hour,int minute,String task,int id)
    {
        ...
        Intent myIntent1 = new Intent(getContext(), UtilityReceiverSat.class);
        ...
        db.update(TaskContract.TaskEntry.TABLE6, values, "_id="+id, null);
        db.close();
    ...
    public static class UtilityReceiverSat  extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
            ...
            Intent myIntent1 = new Intent(context, UtilityReceiverSat.class);
            myIntent1.setAction("MyBroadcast");
    ...
    public void bulkDelete()
    {
        ...
        cursor.close();
        db.delete(TaskContract.TaskEntry.TABLE6, null, null);
        db.close();
        updateUI();
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(hour2>hour1||(hour2==hour1)&&(minute2>minute1))
                        {
                            ...
                            final AlertDialog dialog4= new AlertDialog.Builder(contextThemeWrapper,R.style.f)
                                    .setTitle("Do you want to get a reminder about this task every saturday?")
                                    .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if(edit)
                                            {
                                                db.update(TaskContract.TaskEntry.TABLE6, values, "_id="+idimpo, null);
                                                db.close();
                                                deleteNotification(idimpo);
                                                setNotification(hour1,minute1,task,idimpo);
                                            }
                                            else {
                                                final int id = (int) db.insertWithOnConflict(TaskContract.TaskEntry.TABLE6,
                                                        null,
                                                        values,
                                    ...
                                    .setNegativeButton("NO", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if(edit)
                                            {
                                                ...
                                                db.insertWithOnConflict(TaskContract.TaskEntry.TABLE6,
                                                        null,
                                                        values,
                                                        SQLiteDatabase.CONFLICT_REPLACE);
                                                db.close();
