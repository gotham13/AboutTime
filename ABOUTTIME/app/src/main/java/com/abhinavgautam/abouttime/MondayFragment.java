...
public class MondayFragment extends Fragment {
    private TaskDbHelper mHelperMon;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_global, container, false);
         t=(TextView)rootView.findViewById(R.id.tvf);
        t.setText("MONDAY");
        if(Build.VERSION.SDK_INT>=23)
        t.setTextColor(getResources().getColor(R.color.green,null));
        else
            t.setTextColor(getResources().getColor(R.color.green));
        mHelperMon = new TaskDbHelper(getActivity());
        mTaskListView1 = (ListView) rootView.findViewById(R.id.listView1);
        return rootView;
    }
    private class MyAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            i1.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(), colorIntArray[1]));
            i1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                        ...
                        SQLiteDatabase db = mHelperMon.getWritableDatabase();
            ...
            final ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(main4Activity,R.style.monday);
            ...
            noti.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[1]));
            taski.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[1]));
            taski.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SQLiteDatabase db=mHelperMon.getReadableDatabase();
                    Cursor cursor1 = db.query(TaskContract.TaskEntry.TABLE1,
    ...
    private class BackgroundTask extends AsyncTask <Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog.show();
            db= mHelperMon.getReadableDatabase();
        ...
        protected void onPostExecute(Void result) {
            if (mAdapter2 == null) {
                ...
                mTaskListView1.setAdapter(mAdapter2);
            } else {
                mAdapter2.clear();
            ...
            mTaskListView1.setEmptyView(empty);
        }
        @Override
        protected Void doInBackground(Void... params) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    initime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.green, null)), 0, initime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    endtime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.green, null)), 0, endtime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                } else
                {
                    initime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.green)), 0, initime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    endtime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.green)), 0, endtime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
    ...
    {
        Intent myIntent1 = new Intent(getContext(), UtilityReceiverMon.class);
    ...
    public void bulkDelete()
    {
        ...
        cursor.close();
        db.delete(TaskContract.TaskEntry.TABLE1, null, null);
        db.close();
        updateUI();
    ...
    public void setNotification(int hour,int minute,String task,int id)
    {
        ...
        db.update(TaskContract.TaskEntry.TABLE1, values, "_id="+id, null);
        db.close();
        PendingIntent pendingIntent1 = PendingIntent.getBroadcast(getContext(), id, myIntent1,
    ...
    public static class UtilityReceiverMon  extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
            ...
            Intent myIntent1 = new Intent(context, UtilityReceiverMon.class);
            myIntent1.setAction("MyBroadcast");
    ...
    public void onResume() {
        ...
        main4Activity.button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final AlertDialog dialog=new AlertDialog.Builder(contextThemeWrapper,R.style.f)
                        .setTitle("SELECT DAYS TO COPY")
                        .setView(R.layout.dialog)
                        .create();
                        dialog.show();
                final SwitchCompat all=(SwitchCompat)dialog.findViewById(R.id.switch3);
                SwitchCompat vib=(SwitchCompat)dialog.findViewById(R.id.switch1);
                SwitchCompat sound=(SwitchCompat)dialog.findViewById(R.id.switch2);
                all.setVisibility(View.GONE);
                vib.setVisibility(View.GONE);
                sound.setVisibility(View.GONE);
                final CheckBox c1=(CheckBox)dialog.findViewById(R.id.checkBox);
                final CheckBox c2=(CheckBox)dialog.findViewById(R.id.checkBox2);
                final CheckBox c3=(CheckBox)dialog.findViewById(R.id.checkBox3);
                final CheckBox c4=(CheckBox)dialog.findViewById(R.id.checkBox4);
                final CheckBox c5=(CheckBox)dialog.findViewById(R.id.checkBox5);
                final CheckBox c6=(CheckBox)dialog.findViewById(R.id.checkBox6);
                final CheckBox c7=(CheckBox)dialog.findViewById(R.id.checkBox7);
                ...
                db.execSQL(" INSERT INTO " + TaskContract.TaskEntry.TABLE3 + " SELECT NULL, "+TaskContract.TaskEntry.COL_INITIME+", " + TaskContract.TaskEntry.COL_NOTI+ ", "+ TaskContract.TaskEntry.COL_ROUTINE+" FROM "+
                        TaskContract.TaskEntry.TABLE1);
                db.execSQL(" INSERT INTO " + TaskContract.TaskEntry.TABLE4 + " SELECT NULL, "+TaskContract.TaskEntry.COL_INITIME+", " + TaskContract.TaskEntry.COL_NOTI+ ", "+ TaskContract.TaskEntry.COL_ROUTINE+" FROM "+
                        TaskContract.TaskEntry.TABLE1);
                db.execSQL(" INSERT INTO " + TaskContract.TaskEntry.TABLE5 + " SELECT NULL, "+TaskContract.TaskEntry.COL_INITIME+", " + TaskContract.TaskEntry.COL_NOTI+ ", "+ TaskContract.TaskEntry.COL_ROUTINE+" FROM "+
                        TaskContract.TaskEntry.TABLE1);
                db.execSQL(" INSERT INTO " + TaskContract.TaskEntry.TABLE6 + " SELECT NULL, "+TaskContract.TaskEntry.COL_INITIME+", " + TaskContract.TaskEntry.COL_NOTI+ ", "+ TaskContract.TaskEntry.COL_ROUTINE+" FROM "+
                        TaskContract.TaskEntry.TABLE1);
                db.close();
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    if(hour2>hour1||(hour2==hour1)&&(minute2>minute1))
                    {
                        ...
                        final AlertDialog dialog4= new AlertDialog.Builder(contextThemeWrapper,R.style.f)
                                .setTitle("Do you want to get a reminder about this task every monday?")
                                .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        if(edit)
                                        {
                                            db.update(TaskContract.TaskEntry.TABLE1, values, "_id="+idimpo, null);
                                            db.close();
                                            deleteNotification(idimpo);
                                            setNotification(hour1,minute1,task,idimpo);
                                        }
                                        else {
                                            final int id = (int) db.insertWithOnConflict(TaskContract.TaskEntry.TABLE1,
                                                    null,
                                                    values,
