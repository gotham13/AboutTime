...
public class FridayFragment extends Fragment {
    private TaskDbHelper mHelperFri;
    private ArrayAdapter mAdapter2;
    private ListView mTaskListView5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(Build.VERSION.SDK_INT>=23)
            t.setTextColor(getResources().getColor(R.color.grey,null));
        else
            t.setTextColor(getResources().getColor(R.color.grey));
        mHelperFri = new TaskDbHelper(getActivity());
        mTaskListView5 = (ListView) rootView.findViewById(R.id.listView1);
        return rootView;
    }
    private class BackgroundTask extends AsyncTask <Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog.show();
            db= mHelperFri.getReadableDatabase();
        ...
        protected void onPostExecute(Void result) {
            if (mAdapter2 == null) {
                ...
                mTaskListView5.setAdapter(mAdapter2);
            } else {
                mAdapter2.clear();
            ...
            mTaskListView5.setEmptyView(empty);
        }
        ...
        protected Void doInBackground(Void... params) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    initime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.grey, null)), 0, initime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    endtime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.grey, null)), 0, endtime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                } else
                {
                    initime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.grey)), 0, initime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    endtime1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.grey)), 0, endtime1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
    ...
    private class MyAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view = mInflater.inflate(R.layout.item_todo, mTaskListView5, false);
            FloatingActionButton i1=(FloatingActionButton) view.findViewById(R.id.task_delete);
            i1.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[5]));
            i1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SQLiteDatabase db = mHelperFri.getWritableDatabase();
            ...
            final ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(main4Activity,R.style.friday);
            ...
            noti.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[5]));
            taski.setBackgroundTintList(ContextCompat.getColorStateList(getActivity().getApplicationContext(),colorIntArray[5]));
            taski.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SQLiteDatabase db=mHelperFri.getReadableDatabase();
                    Cursor cursor1 = db.query(TaskContract.TaskEntry.TABLE5,
                            new String[]{TaskContract.TaskEntry._ID,TaskContract.TaskEntry.COL_NOTI, TaskContract.TaskEntry.COL_INITIME, TaskContract.TaskEntry.COL_ROUTINE},
    ...
    public void setNotification(int hour,int minute,String task,int id)
    {
        ...
        Intent myIntent1 = new Intent(getContext(), UtilityReceiverFri.class);
        ...
        db.update(TaskContract.TaskEntry.TABLE5, values, "_id="+id, null);
        db.close();
    ...
    public static class UtilityReceiverFri  extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
            ...
            Intent myIntent1 = new Intent(context, UtilityReceiverFri.class);
            myIntent1.setAction("MyBroadcast");
    ...
    public void bulkDelete()
    {
        ...
        cursor.close();
        db.delete(TaskContract.TaskEntry.TABLE5, null, null);
        db.close();
        updateUI();
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(hour2>hour1||(hour2==hour1)&&(minute2>minute1))
                        {
                            ...
                            final AlertDialog dialog4= new AlertDialog.Builder(contextThemeWrapper,R.style.f)
                                    .setTitle("Do you want to get a reminder about this task every friday?")
                                    .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if(edit)
                                            {
                                                db.update(TaskContract.TaskEntry.TABLE5, values, "_id="+idimpo, null);
                                                db.close();
                                                deleteNotification(idimpo);
                                                setNotification(hour1,minute1,task,idimpo);
                                            }
                                            else {
                                                final int id = (int) db.insertWithOnConflict(TaskContract.TaskEntry.TABLE5,
                                                        null,
                                                        values,
