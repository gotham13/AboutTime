...
public class sector_database extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sector_database);
        ...
        String p_n = pc_name.getString("pc");
        l_n = lac_name.getString("lac");
        ...
        Button_show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final ProgressDialog pd = new ProgressDialog(sector_database.this);
                    ...
                    query.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.exists()) {
                                ...
                                count.setText(i + "");
                                member_new_listview = (ListView) findViewById(R.id.member_lac_listview);
                                Member_Lac_Adapter adapter = new Member_Lac_Adapter(sector_database.this, arrayList);
                                member_new_listview.setAdapter(adapter);
                                registerForContextMenu(member_new_listview);
                                pd.hide();
                            } else {
                                Toast.makeText(sector_database.this, "There is no data available", Toast.LENGTH_SHORT).show();
                                member_new_listview = (ListView) findViewById(R.id.member_lac_listview);
                                Member_Lac_Adapter adapter = new Member_Lac_Adapter(sector_database.this, arrayList);
                                member_new_listview.setAdapter(adapter);
                                TextView count = (TextView) findViewById(R.id.count);
                ...
                member_new_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent intent=new Intent(sector_database.this,details.class);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        if (v.getId() == R.id.member_lac_listview) {
            ...
            if (get_name == null) {
                ...
                MenuInflater inflater = getMenuInflater();
                inflater.inflate(R.menu.context_menu_sector_volunteer, menu);
