        ...
        public class Pc extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
            private FirebaseDatabase firebaseDatabase;
            private DatabaseReference databaseReference;
            FloatingActionButton fabs, fabl;
            Spinner LAC;
            Spinner SECTOR;
            Button Button_show;
            ...
            String check_data;
            ArrayList<Member_lac_data> arrayList;
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                LAC = (Spinner) findViewById(R.id.spinner_lac);
                fabl = (FloatingActionButton) findViewById(R.id.fab);
                fabs = (FloatingActionButton) findViewById(R.id.sector_fab);
                ...
                Bundle Extras_pc = getIntent().getExtras();

                Bundle Extra_key = getIntent().getExtras();
                String key = Extra_key.getString("key");
                pc = Extras_pc.getString("pc");
                TextView textView_pc_name = (TextView) findViewById(R.id.pc_observer_name);
                TextView textView_pc_obs_name = (TextView) findViewById(R.id.pc_name);
                textView_pc_name.setText(pc);
                textView_pc_obs_name.setText(name);
                ArrayAdapter<CharSequence> lac_adapter = null;
                switch (Integer.parseInt(key)) {
                    case 1:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Kasaragod1, android.R.layout.simple_spinner_item);
                        break;
                    case 2:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Kannur1, android.R.layout.simple_spinner_item);
                        break;
                    case 3:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Vadakara1, android.R.layout.simple_spinner_item);
                        break;
                    case 4:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Wayanad, android.R.layout.simple_spinner_item);
                        break;
                    case 5:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Kozhikode, android.R.layout.simple_spinner_item);
                        break;
                    case 6:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Malappuram1, android.R.layout.simple_spinner_item);
                        break;
                    case 7:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Ponnani1, android.R.layout.simple_spinner_item);
                        break;
                    case 8:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Palakkad1, android.R.layout.simple_spinner_item);
                        break;
                    case 9:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Alathur1, android.R.layout.simple_spinner_item);
                        break;
                    case 10:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Thrissur1, android.R.layout.simple_spinner_item);
                        break;
                    case 11:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Chalakudy, android.R.layout.simple_spinner_item);
                        break;
                    case 12:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Ernakulam1, android.R.layout.simple_spinner_item);
                        break;
                    case 13:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Idukki1, android.R.layout.simple_spinner_item);
                        break;
                    case 14:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Kottayam1, android.R.layout.simple_spinner_item);
                        break;
                    case 15:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Alappuzha1, android.R.layout.simple_spinner_item);
                        break;
                    case 16:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Mavelikkara1, android.R.layout.simple_spinner_item);
                        break;
                    case 17:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Pathanamthitta, android.R.layout.simple_spinner_item);
                        break;
                    case 18:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Kollam1, android.R.layout.simple_spinner_item);
                        break;
                    case 19:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Attingal1, android.R.layout.simple_spinner_item);
                        break;
                    case 20:
                        lac_adapter = ArrayAdapter.createFromResource(
                                Pc.this, R.array.Thiruvananthapuram1, android.R.layout.simple_spinner_item);
                        break;

                    default:
                        break;
                }
                LAC.setAdapter(lac_adapter);
                lac_adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                LAC.setOnItemSelectedListener(this);
        ...
        Button_show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final ProgressDialog pd = new ProgressDialog(Pc.this);
                pd.setMessage("loading");
                pd.setCanceledOnTouchOutside(false);
                pd.show();
                String lac = LAC.getSelectedItem().toString();
                ...
                if (lac.equals("All") && (sector.equals("All"))) {
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.exists()) {
                                ...
                                count.setText(i + "");
                                member_listview = (ListView) findViewById(R.id.member_listview);
                                Member_Lac_Adapter adapter = new Member_Lac_Adapter(Pc.this, arrayList);
                                member_listview.setAdapter(adapter);
                                pd.hide();
                                //  registerForContextMenu(member_listview);
                            } else {
                                Toast.makeText(Pc.this, "There is no data available", Toast.LENGTH_SHORT).show();
                                member_listview = (ListView) findViewById(R.id.member_listview);
                                Member_Lac_Adapter adapter = new Member_Lac_Adapter(Pc.this, arrayList);
                                member_listview.setAdapter(adapter);
                                registerForContextMenu(member_listview);
                    ...
                    String[] strings = lac.split("-");
                    String new_lac = strings[1].trim();
                    final String new_sector = SECTOR.getSelectedItem().toString();
                    Query query = databaseReference.child("MEMBERS").orderByChild("LAC").equalTo(new_lac.toUpperCase());
                    query.keepSynced(true);
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
        ...
        member_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
               ...
               Intent intent=new Intent(Pc.this,details.class);
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if (!(lac.trim().equals("All"))) {
            ...
            ArrayAdapter all_sector_adapter = ArrayAdapter.createFromResource(this, R.array.All, android.R.layout.simple_spinner_item);
            SECTOR.setAdapter(all_sector_adapter);
            all_sector_adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        }
    ...
    public void sector_observer(View v){
        Intent intent=new Intent(this,pc_lac_sector_observer.class);
        intent.putExtra("pc",pc);
        startActivity(intent);

    }
    public void lac_observer(View v){
        Intent intent=new Intent(this,lac_observer.class);
        intent.putExtra("pc",pc);
        startActivity(intent);
    ...
    public void add(View view) {
        ...
        startActivity(intent);
            ...
            public void onResume(){
                super.onResume();
                fabs.setImageBitmap(textAsBitmap("SEC", 40, Color.WHITE));
                fabl.setImageBitmap(textAsBitmap("LAC", 40, Color.WHITE));
            }
}